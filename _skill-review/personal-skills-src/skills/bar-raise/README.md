...
Periodic deep-review skill for Nick's portfolio. Five-wave structure, lens-driven, produces Markdown findings + JSON status for the dashboard at `yesandeverything.com/status/`.
...
bar-raise/
  ...
  waves/
    ...
    03_tier1_lenses/                         Wave 3 (11 lenses, every project)
      01_architecture.md
      02_reliability.md
      03_security.md
      04_performance.md
    ...
    05_meta_synthesis.md                     Wave 5 (collapse to verdict + actions)
  orchestrators/
