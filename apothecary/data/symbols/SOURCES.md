...
variants were cut from their solid siblings by the regen pass and carry no source of their
own: each inherits the candidates and the licence of the solid file it was cut from, which is
what their rows below now say (compliance-data-steward-02, 2026-09-23).
...
| awen-hollow.png | derived from awen-solid.png | inherits awen-solid.png | 2026-09-23 | cut from the solid variant by the regen pass; the candidates and the licence are the solid file's rows above |
...
| celtic-cross-hollow.png | derived from celtic-cross-solid.png | inherits celtic-cross-solid.png | 2026-09-23 | cut from the solid variant by the regen pass; the candidates and the licence are the solid file's rows above |
...
| celtic-knot-hollow.png | derived from celtic-knot-solid.png | inherits celtic-knot-solid.png | 2026-09-23 | cut from the solid variant by the regen pass; the candidates and the licence are the solid file's rows above |
...
| shield-knot-hollow.png | derived from shield-knot-solid.png | inherits shield-knot-solid.png | 2026-09-23 | cut from the solid variant by the regen pass; the candidates and the licence are the solid file's rows above |
...
| triskele-hollow.png | derived from triskele-solid.png | inherits triskele-solid.png | 2026-09-23 | cut from the solid variant by the regen pass; the candidates and the licence are the solid file's rows above |
