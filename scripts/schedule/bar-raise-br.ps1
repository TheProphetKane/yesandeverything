...
# orchestrator at orchestrators/per_project.md against Brackish Rising.
#
# Output lands in:
...
$LogPath = Join-Path $LogDir "bar-raise-br-$Today.log"
...
# orchestrators/per_project.md runs against Brackish Rising.
$Prompt = "bar-raise BR"
...
"$(Get-Date -Format o) START bar-raise-br" | Tee-Object -FilePath $LogPath -Append
...
"$(Get-Date -Format o) END bar-raise-br exit=$rc" | Tee-Object -FilePath $LogPath -Append
