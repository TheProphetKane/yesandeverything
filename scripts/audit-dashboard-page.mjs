...
const proc = spawn(chrome, ["--headless=new", "--disable-gpu", "--no-sandbox", "--window-size=1600,4000", `--remote-debugging-port=${port}`, `--user-data-dir=${profile}`, "about:blank"], { stdio: "ignore" });
